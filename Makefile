...
ARTIFACTS_DIGITS_DIR = $(ARTIFACTS_DIR)/digits
ARTIFACTS_DIGITS_CHECKPOINTS_DIR = $(ARTIFACTS_DIGITS_DIR)/checkpoints
DATA_DIR = data
...
artifacts-dirs:
	...
	$(call MKDIR_P,$(ARTIFACTS_DIGITS_DIR))
	$(call MKDIR_P,$(ARTIFACTS_DIGITS_CHECKPOINTS_DIR))
